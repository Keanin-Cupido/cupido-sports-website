...
function Testimonial_Section() {
    return (
        <Box height="600px" backgroundColor="#2DB2B6" justifyContent="center" alignItems="center" alignContent="center" textAlign="center">
            <Text fontSize="4xl" color={col} textAlign="center" pt="5%" fontWeight="black">TESTIMONIALS</Text>
            <Flex flexDirection="column" alignItems="center" justifyContent="center" >
                <Text fontSize="xl" w="55%" color={col} textAlign="center" pt="2%">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum tincidunt velit non erat cursus, id gravida elit porta. 
                ...
                <Text fontSize="xl" color={col} textAlign="center" pt="2%" fontStyle="italic" fontWeight="bold">
                    Ashwin Cupido
                </Text>
